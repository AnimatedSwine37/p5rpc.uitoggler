...
namespace p5rpc.uitoggler
{
    internal static class Signatures
    {
        ...
        internal static readonly SigInfo RenderDateSig = new SigInfo("40 53 55 56 57 41 56 48 81 EC 80 00 00 00 44 0F BF 4A ??", "Date", "ret");
        ...
        internal static readonly SigInfo RenderBattleBackConfirmSig = new SigInfo("40 55 53 56 57 48 8D 6C 24 ?? 48 81 EC 98 00 00 00 4C 8B 05 ?? ?? ?? ??", "Battle Back Confirm", "ret");
        ...
        internal static readonly SigInfo RenderCraftingPromptsSig = new SigInfo("48 8B C4 F3 0F 11 48 ?? 55 48 81 EC 00 01 00 00", "Crafting Prompts", "ret");
        ...
        internal static readonly SigInfo RenderHoldupBreakFormationSig = new SigInfo("E8 ?? ?? ?? ?? 48 8B 43 ?? 48 8B 48 ?? 44 38 A1 ?? ?? ?? ??", "Holdup Break Formation", "mov rax, [rbx+0x48]");
        internal static readonly SigInfo RenderHoldupTalkSig = new SigInfo("F3 0F 11 45 ?? E8 ?? ?? ?? ?? 48 8D 35 ?? ?? ?? ??", "Holdup Talk", "movss [rbp+0x68],xmm2");
        ...
        internal static readonly SigInfo RenderResultsNextSig = new SigInfo("F3 0F 11 44 24 ?? E8 ?? ?? ?? ?? BE C8 0F 00 00", "Results Next", "movss [rsp+0x20],xmm0");
        ...
        internal static readonly SigInfo RenderChallengeBattlePromptsSig = new SigInfo("48 8B C4 41 54 48 81 EC 30 01 00 00 4C 8B 61 ??", "Challenge Battle Menu Prompts", "ret");
